...
from face_restoration.archs.vqfr.vqganv2_arch import ResnetBlock, VQGANDecoder, VQGANEncoder, build_quantizer
from face_restoration.ops.dcn import ModulatedDeformConvPack, modulated_deform_conv
...
class VQFRv2(nn.Module):
    ...
    def forward(self, x_lq, fidelity_ratio=1.0,**kwargs):
        fidelity_ratio = kwargs.get('w', 0.5)
